...
function Blog({ display, backgroundSize = "cover", blog }) {
    ...
    useEffect(() => {
        console.log('hdue', blog?.thumbnail);
    }, []);
    return (
        blog && (
            <div
                ...
                onClick={() =>
                    (window.location.href = "/blog-detail/" + blog?.slug)
                }
            >
                <div
                    ...
                    style={{
                        ...
                        backgroundImage: `url(${STORAGE_URL}${blog?.thumbnail})`,
     ...
     biết? */}
                    ...
                    <span className="date">Time: {FormatDate(blog?.updated_at)}</span>
                    <div
                        className="content "
