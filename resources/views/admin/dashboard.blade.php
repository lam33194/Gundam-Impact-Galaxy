    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-body p-4">
                    <div class="text-center mb-3">
                        <img src="/assets/theme/admin/images/companies/airbnb.svg" alt="" class="avatar-sm">
        ...
        <div class="col-lg-2">
            <div class="card">
                <div class="card-body p-4">
                    <div class="text-center mb-3">
                        <img src="/assets/theme/admin/images/companies/mailchimp.svg" alt="" class="avatar-sm">
                        <a href="job-details.html" class="text-body">
        ...
        <div class="col-lg-2">
            <div class="card">
                <div class="card-body p-4">
                    <div class="text-center mb-3">
                        <img src="/assets/theme/admin/images/companies/reddit.svg" alt="" class="avatar-sm">
                        <a href="job-details.html" class="text-body">
        ...
        <div class="col-lg-2">
            <div class="card">
                <div class="card-body p-4">
                    <div class="text-center mb-3">
                        <img src="/assets/theme/admin/images/companies/amazon.svg" alt="" class="avatar-sm">
                        <a href="job-details.html" class="text-body">
        ...
        <div class="col-lg-2">
            <div class="card">
                <div class="card-body p-4">
                    <div class="text-center mb-3">
                        <img src="/assets/theme/admin/images/companies/line.svg" alt="" class="avatar-sm">
                        <a href="job-details.html" class="text-body">
                            ...
                            <li class="event-list">
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0 me-3">
                                        <img src="/assets/theme/admin/images/users/avatar-5.jpg" alt=""
                ...
                <div class="card-body">
                    ...
                    <div data-simplebar style="max-height: 376px;">
                        <div class="vstack gap-4">
                            <div class="d-flex">
                                <img src="/assets/theme/admin/images/companies/wechat.svg" alt="" height="40"
                                    class="rounded">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="dropdown">
                                    <button class="btn btn-light" type="button" id="dropdownMenuButton2"
                                        data-bs-toggle="dropdown" aria-expanded="false">
                                        <i class="bx bx-dots-vertical-rounded"></i>
                                    </button>
                            ...
                            <div class="d-flex">
                                <img src="/assets/theme/admin/images/companies/adobe.svg" alt="" height="40"
                                    class="rounded">
                                <div class="ms-2 flex-grow-1">
                                ...
                                <div class="dropdown">
                                    <button class="btn btn-light" type="button" id="dropdownMenuButton3"
                                        data-bs-toggle="dropdown" aria-expanded="false">
                                        <i class="bx bx-dots-vertical-rounded"></i>
                                    </button>
                            ...
                            <div class="d-flex">
                                <img src="/assets/theme/admin/images/companies/airbnb.svg" alt="" height="40"
                                    class="rounded">
                                <div class="ms-2 flex-grow-1">
                                ...
                                <div class="dropdown">
                                    <button class="btn btn-light" type="button" id="dropdownMenuButton4"
                                        data-bs-toggle="dropdown" aria-expanded="false">
                                        <i class="bx bx-dots-vertical-rounded"></i>
                                    </button>
                            ...
                            <div class="d-flex">
                                <img src="/assets/theme/admin/images/companies/flutter.svg" alt="" height="40"
                                    class="rounded">
                                <div class="ms-2 flex-grow-1">
                                ...
                                <div class="dropdown">
                                    <button class="btn btn-light" type="button" id="dropdownMenuButton5"
                                        data-bs-toggle="dropdown" aria-expanded="false">
                                        <i class="bx bx-dots-vertical-rounded"></i>
                                    </button>
                            ...
                            <div class="d-flex">
                                ...
                                <div class="dropdown">
                                    <button class="btn btn-light" type="button" id="dropdownMenuButton6"
                                        data-bs-toggle="dropdown" aria-expanded="false">
                                        <i class="bx bx-dots-vertical-rounded"></i>
                                    </button>
                            ...
                            <div class="d-flex">
                                <img src="/assets/theme/admin/images/companies/spotify.svg" alt="" height="40"
                                    class="rounded">
                                <div class="ms-2 flex-grow-1">
                                ...
                                <div class="dropdown">
                                    <button class="btn btn-light" type="button" id="dropdownMenuButton7"
                                        data-bs-toggle="dropdown" aria-expanded="false">
                                        <i class="bx bx-dots-vertical-rounded"></i>
                                    </button>
                            ...
                            <div class="d-flex">
                                <img src="/assets/theme/admin/images/companies/reddit.svg" alt="" height="40"
                                    class="rounded">
                                <div class="ms-2 flex-grow-1">
                                ...
                                <div class="dropdown">
                                    <button class="btn btn-light" type="button" id="dropdownMenuButton8"
                                        data-bs-toggle="dropdown" aria-expanded="false">
                                        <i class="bx bx-dots-vertical-rounded"></i>
                                    </button>
