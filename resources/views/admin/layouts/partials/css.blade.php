...
<!-- Plugins css -->
<link href="{{ asset('assets/theme/admin/libs/dropzone/dropzone.css') }}" rel="stylesheet" type="text/css" />
<link href="{{ asset('assets/theme/admin/libs/select2/css/select2.min.css') }}" rel="stylesheet" type="text/css" />
<!-- Lightbox css -->
<link href="{{ asset('assets/theme/admin/libs/magnific-popup/magnific-popup.css') }}" rel="stylesheet"
    type="text/css" />
