                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input name="product[price_regular]" type="number" class="form-control @error('product.price_regular')
                                                is-invalid
                                            @enderror" placeholder="Enter product price_regular..."
                                                value="{{ old('product.price_regular') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('product.description') is-invalid @enderror"
                                        name="product[description]">{{ old('product.description') }}</textarea>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control select2-multiple" name="product[category_id]">
                                        @foreach ($categories as $category)
                                            <option {{ old("product.category_id") == $category->id ? 'selected' : '' }}
