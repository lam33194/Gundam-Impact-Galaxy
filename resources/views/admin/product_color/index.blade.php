                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end" style="">
                                            <li>
                                                ...
                                                <form action="{{ route('admin.product-colors.destroy', $color->id) }}" method="POST"
                                                    ...
                                                    @csrf
                                                    @method('DELETE')
                                                    <button class="dropdown-item remove-list" onclick="return confirm('Chắc chắn xóa')" type="submit" class="btn btn-danger"><i class="mdi mdi-trash-can font-size-12 text-danger me-1"></i>Xóa</button>
                                                </form>
                                            </li>
                                        </ul>
                                    </div>
